...
// For testing the overlay, comment out the line below. 
// To test logged in state, uncomment it and set it to true.
// $_SESSION['logged_in'] = true; 

$display_name = $_SESSION['display_name'] ?? 'Scholar';

// Include our new Header/Footer file
...
<head>
    ...
    <style>
        /* Updated body to a vertical flex container so header and footer sit correctly */
        body { 
            display: flex; 
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card gemini-card p-4 mb-4">
                    ...
                    <p class="text-muted">Unlike standard chatbots, you must force structured interaction. Start a prompt below.</p>
            ...
            <div class="col-lg-4">
                <div class="card gemini-card p-4 h-100" style="background-color: #F4EFE6;">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="text-muted small">Choose your specific context, task, and format from the dropdowns.</span>
                    </div>

                    <div class="mb-3">
                        <strong class="d-block text-dark">2. Provide Input</strong>
                        <span class="text-muted small">Write a targeted text input to receive a strictly formatted JSON lesson plan.</span>
                    </div>

                    <div>
                        <strong class="d-block text-dark">3. Earn Rebates</strong>
                        <span class="text-muted small">You spend virtual currency to generate content, but you can earn rebates for high-quality prompts.</span>
                    </div>
                </div>
            </div>
        </div>
